...
params.signalChange = 5;       % Threshold for intensity change detection
...
params.camera.QE = 0.65;        % Quantum efficiency

%Camera settings of this experiment
params.camera.exposure_time = 0.03;  % Exposure time in seconds
params.camera.frame_interval = 0.03; % Time between frames in seconds
params.EM_wave_FP = 450;

% Pixel size information
params.IM_info = [110, 110];    % Pixel size in nm [x, y]

% Paths
params.totalfn_path = 'D:\00 Backup\Dye_code-main_0518\totalfn';
params.baseDir = 'E:\50 nM probe living hela';  % Add baseDir to params
