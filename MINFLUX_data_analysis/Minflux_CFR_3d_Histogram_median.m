...
cfr_column7 = itr.cfr(:,7); 
median_value = median(cfr_column7); 

% Create histogram with customized bars
figure;
h = histogram(cfr_column7,...
    'EdgeColor', [0.1 0.4 0.7],...      
    'FaceColor', [0.35 0.75 1],...      
    'LineWidth', 1.2,...                
    'BinWidth', 0.8*range(cfr_column7)/30); 

title('Distribution of CFR Column 7 Data');
xlabel('CFR Column 7 Values');
